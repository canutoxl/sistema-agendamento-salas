...
const agendamentosIniciais = [ 
    { id: 1, solicitante: "Prof. Carlos Eduardo", bloco: "BlocoA", sala: "Laboratório de Informática 1", data: "2026-09-15", turno: "Manhã" }, 
    { id: 2, solicitante: "Profa. Ana Maria", bloco: "Bloco B", sala: "Sala 201", data: "2026-09-15",turno: "Noite" } ];


export {infraestrutura, agendamentosIniciais};
